# Agentic SDLC Starter Kit — v2

**What's new in v2: cost control.** Same seven-stage pipeline as v1,
now with model routing, token budgets, and a self-computed bill —
measured on a real story at **~44% cheaper** than running everything on
the top model, with zero gates weakened.
...
Fifteen rules total in [docs/rules/model-routing-rules.md](docs/rules/model-routing-rules.md),
