...
9. Append numbered `BLOCKER`, `SHOULD`, and `NOTE` findings. Record evidence and resolution without deleting the original concern.
10. Obtain the required human design decision for `HIGH` and `CRITICAL` work.
